    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_PERMISSION_CAMERA) {
            if (grantResults.length < 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("We need to use the camera for the app to work.")
            ...
            if (grantResults.length < 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("We need to use the file storage for the app to work.")
                        .show(getChildFragmentManager(), FRAGMENT_DIALOG);
            }
        }else if (requestCode == REQUEST_PERMISSION_PHONE) {
            if (grantResults.length < 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance("We need to know the phone serial number.")
                        .show(getChildFragmentManager(), FRAGMENT_DIALOG);
            }
        }
